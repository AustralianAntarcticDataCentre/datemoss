...
##' a maximal growth rate then dates will be generated such that the
...
##'
##' The user must supply the lengths \code{ls} and mean carbon
##' concentrations \code{cs} of the segments.  These must be supplied
...
##' endpoint times and \code{ls} the lengths of the n segments.  This
...
##' @param tmin the minimum possible date
##' @param ls lengths of the segments (in timewise order, oldest
##' first)
##' @param cs carbon concentrations of segments (in timewise order,
##' oldest first)
...
##' sample of segment dates generated by \code{metropolisDate}, and
